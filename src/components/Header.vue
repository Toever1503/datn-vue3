          ...
          <div class="h-16 flex items-center">
            ...
            <PopoverGroup class="hidden lg:ml-8 lg:block lg:self-stretch">
              <div class="h-full flex space-x-8">
                ...
                <!--                            &lt;!&ndash; <div class="col-start-2 grid grid-cols-2 gap-x-8">-->
                <!--                              <div-->
                <!--                                v-for="item in category.featured"-->
                <!--                                :key="item.name"-->
...
import BilBil from '../assets/BilBil.png';
...
header #search-nav, header .ant-input-search > .ant-input-group > .ant-input-group-addon:last-child .ant-input-search-button:not(.ant-btn-primary) {
  border: none;
}
</style>